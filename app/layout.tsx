...
const jsonLd = {
  ...
  sameAs: [club.socials.facebook, club.socials.instagram, club.socials.linkedin].filter(Boolean),
};
  ...
  return (
    <html lang="en">
      <body className={fontVariables}>
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:bg-gold focus:px-4 focus:py-2 focus:text-sm focus:font-bold focus:text-ink"
        >
          Skip to content
        </a>
